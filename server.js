...
const openai = createOpenAI({
  apiKey:
    "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",
});
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an asistant, User will provide a text to you and you will tell on which screen user should naviagate and if user is searching then just give me name of vegetable or fruit name in english which user is searching in text",
        },
        {
          role: "user",
          content: userInput,
